...
- **Email — batch, don't drip.** Round-trips are slow and scarce, so present the **whole set in one message** and let the person answer it all at once.
  ...
  - **Follow-up emails (also batched — EVERY email carries ~3 questions):** a short **recap/acknowledgement** paragraph, then a short **numbered batch of ~3** — usually one or two follow-ups that go deeper on what was thin or interesting, plus one **new question** that advances the essence (bold the brand-new one). **Never** drip a single question and wait — one-then-wait wastes the person's time and they won't keep returning; get maximum context per reply, and relate it to the client's questions/context.
