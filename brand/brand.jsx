/* ============================================================
   OBSERVANT — Brand / logo explorations (design canvas content)
...
function Brand() {
  return (
    <DesignCanvas>
        ...
        <DCArtboard id="w-a" label="A · The full stop" width={420} height={240}>
          <Board>
            <div style={{ textAlign: "center" }}>
              <div className="lw">observant<span className="ac">.</span></div>
          ...
          <Board>
            <div style={{ textAlign: "center" }}>
              <div className="lw" style={{ display: "inline-flex", alignItems: "center", gap: "0.34em" }}>
                <span className="pair"><i></i><i></i></span>observant
              </div>
      ...
      {/* ============ RECOMMENDED SYSTEM ============ */}
      <DCSection id="system" title="Recommended · “the pair”" subtitle="Wordmark observant + a two-dot mark that means 1:1 — and a reusable device across the UI">
