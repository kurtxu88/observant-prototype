/* ============================================================
   EDDA app — Setup flow (build a learning program)
   ============================================================ */
        ...
        {launching ? (
          ...
          <main className="setup-main">
            <div className="setup-stage">
              {step === 0 && (
                <Step head={{ eyebrow: "Step 1", h1: "What do you want to learn?", p: "Brief Edda like you'd brief a researcher. It encodes real qualitative methodology — you bring the question." }}>
                  <div className="field">
                  ...
                  <div className="field">
                    <label>Product <span className="hint">what Edda will reference in conversations</span></label>
              ...
              {step === 2 && (
                <Step head={{ eyebrow: "Step 3", h1: "How continuous?", p: "Edda runs like a diary study — the longer it runs, the more it learns. You can change this anytime." }}>
                ...
                <Step head={{ eyebrow: "Step 4", h1: "Where it lives.", p: "Each user gets a private 1:1 line — never a noisy shared channel. Offer the surfaces you want; users pick their own." }}>
                  <div className="opt-grid two">
                    {[["product", "globe", "In your product", "An embedded companion inside Northwind."],
                      ...
                      ["app", "phone", "Edda app", "A dedicated space on their phone."]].map(([k, ic, nm, d]) => (
              ...
              {step === 4 && (
                <Step head={{ eyebrow: "Step 5", h1: "Review & launch.", p: "Edda will open private 1:1 lines and begin the moment you launch." }}>
...
function LaunchScreen({ product }) {
  const lines = [
    ...
    "Encoding your brief into Edda's methodology…",
    `Syncing with ${product}…`,
    "Edda is reaching out to your first users.",
  ];
