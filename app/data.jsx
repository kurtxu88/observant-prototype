/* ============================================================
   OBSERVANT app — seed data (demo workspace: "Northwind")
   ============================================================ */
...
const PANEL = {
  dana: {
    ...
    thread: [
      { t: "them", text: "Hi Dana — it's Observant. You just shipped your third weekly export. Mind if I ask what you do with it once it leaves the app?", meta: "Observant · auto-started · Mon" },
      { t: "user", text: "Honestly I paste it into a Google Sheet and rebuild half of it by hand.", meta: "Dana · Mon" },
      { t: "them", text: "That sounds tedious. What's the part you rebuild — the formatting, or the actual numbers?", meta: "Observant" },
  ...
  marcus: {
    ...
    thread: [
      { t: "them", text: "Hey Marcus — noticed you ran into an error twice this afternoon. What were you trying to do right then?", meta: "Observant · behavior-triggered" },
      { t: "user", text: "Bulk-importing my Q2 contacts. I hit the rate limit again around 4pm.", meta: "Marcus" },
      { t: "them", text: "Got it. Is bulk import usually a once-a-quarter thing, or more often?", meta: "Observant" },
    ],
  },
  priya: {
    ...
    thread: [
      { t: "them", text: "Welcome to Northwind, Priya! I'm Observant — I'll check in now and then to learn what's working for you. What made you sign up this week?", meta: "Observant · onboarding · day 1" },
      { t: "user", text: "My old tool got acquired and shut down. Day one here — still figuring out where things are.", meta: "Priya" },
    ],
  },
  leah: {
    id: "leah", name: "Leah M.", color: "plum", cohort: "Recruited", surface: "Observant app",
    last: "I'd probably stay if the mobile app caught up.", time: "3h", live: false,
    thread: [
      { t: "them", text: "Thanks for joining the panel, Leah. You mentioned you've been evaluating a few tools — what would make you commit to one?", meta: "Observant · churn follow-up" },
  ...
  owen: {
    ...
    thread: [
      { t: "them", text: "Owen — you're in the top 1% of API usage this month. What are you building on top of us?", meta: "Observant · behavior-triggered" },
