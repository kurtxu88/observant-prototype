/* ============================================================
   OBSERVANT app — Portal (shell · programs · detail · insights · panel)
   ============================================================ */
  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1>Your programs</h1>
          <div className="sub">User learning on autopilot. Each program runs continuously — like a diary study that never goes cold.</div>
        </div>
      </div>
      <div className="prog-grid">
        ...
        <button className="prog-card new-card" onClick={onNew} type="button">
          ...
          <span style={{ fontSize: "0.82rem" }}>Brief Observant on what to learn next</span>
        </button>
      </div>
    </div>
  );
        ...
        <div className="panel-box">
          ...
          {members.length === 0 && (
            <div style={{ padding: "2.5rem 1.25rem", textAlign: "center", color: "var(--text-muted)" }}>
              Observant is opening the first 1:1 lines — conversations will appear here shortly.
            </div>
          )}
        </div>
  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1>Panel</h1>
          <div className="sub">Everyone on a private 1:1 line with Observant, across all programs.</div>
        </div>
      </div>
      <div className="panel-box">
