...
(function () {
  ...
  const chatScript = [
    { type: 'them', text: "Hi Dana — it's Edda. You just shipped your third weekly export. Mind if I ask what you do with it once it leaves the app?", meta: 'Edda · auto-started' },
    ...
    { type: 'relay', tag: 'Your team requested', text: "A 15-min live 1:1 with Dana — Edda is finding a time." },
  ];
