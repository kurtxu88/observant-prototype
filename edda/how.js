/* ============================================================
   EDDA — /how-it-works interactions (reveals + rich 1:1 demo)
   ============================================================ */
(function () {
  'use strict';
  ...
  /* ---------- rich 1:1 demo ---------- */
  const script = [
    { type: 'them', text: "Marcus — I noticed you hit an error twice this afternoon while bulk-importing. What were you trying to get done right then?", meta: 'Edda · behavior-triggered · 4:06pm' },
    ...
    { type: 'them', text: "Got it. Is that a once-a-quarter push, or something you do more often?", meta: 'Edda' },
    ...
    { type: 'them', text: "Happy to set that up. Marcus — the team would love 15 minutes to see this live. Does Thursday 2pm work?", meta: 'Edda' },
    { type: 'typing', after: 850 },
